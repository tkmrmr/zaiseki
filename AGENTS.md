...
- `python3 -m py_compile backend/cgi-bin/zaiseki/api/app.py backend/cgi-bin/zaiseki/api/index.cgi backend/cgi-bin/zaiseki/api/routes/*.py backend/cgi-bin/zaiseki/api/common/*.py backend/cgi-bin/zaiseki/api/services/*.py`: quick syntax check for backend Flask/CGI changes.
...
## Testing Guidelines
There is currently no automated test suite checked in. At minimum, run `npm run build` for frontend changes, `npm run lint` for frontend changes, `python3 -m py_compile backend/cgi-bin/zaiseki/api/app.py backend/cgi-bin/zaiseki/api/index.cgi backend/cgi-bin/zaiseki/api/routes/*.py backend/cgi-bin/zaiseki/api/common/*.py backend/cgi-bin/zaiseki/api/services/*.py` for backend Flask/CGI changes, and manually verify the affected UI or API flow.
